...
/*   Updated: 2022/04/21 18:49:37 by bbonaldi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	ft_lstmap(head, &change_first_letter, &free);
	size_t i = 0;
	size_t final_result = 0;
	check_list(head, result, &i, &final_result, "ft_lstmap");
	return (0);
}
